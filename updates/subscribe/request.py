...
def _fetch_single_subscribe_sync(
    ...
    *,
    ...
    discovered_epg_urls=None,
    epg_discover_lock=None,
):
    ...
    try:
        ...
        if response:
            ...
            if content:
                ...
                if open_subscribe_epg and m3u_type and discovered_epg_urls is not None:
                    found_epg_urls = get_m3u_epg_urls(content)
                    if found_epg_urls:
                        if epg_discover_lock is not None:
    ...
    with ThreadPoolExecutor(max_workers=10) as executor:
        futures = [
            executor.submit(
                ...
                open_subscribe_epg=open_subscribe_epg,
                discovered_epg_urls=discovered_epg_urls,
                epg_discover_lock=epg_discover_lock,
            )
        ...
        if epg_urls_out is not None and discovered_epg_urls:
            ...
            logger.info(t("msg.subscribe_epg_found").format(count=len(discovered_epg_urls)))
